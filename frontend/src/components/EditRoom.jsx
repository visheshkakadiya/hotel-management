...
const EditRoom = () => {
    ...
    useEffect(() => {
        const fetchRoom = async () => {
            try {
                setLoading(true);
                const res = await axiosInstance.get(`/rooms/room/${roomId}`);
                ...
                setImagePreview(room.roomImage?.url || null);
            } catch (error) {
    ...
    const validateForm = () => {
        ...
        else if (isNaN(formData.capacity) || parseInt(formData.capacity) <= 0) newErrors.capacity = 'Please enter a valid capacity';
        setErrors(newErrors);
    ...
    const handleSubmit = async (e) => {
        ...
        if (validateForm()) {
            try {
                ...
                const res = await axiosInstance.patch(`/rooms/update-room/${roomId}`, form, {
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-lg border shadow-sm">
                    <div className="p-6 border-b">
                        ...
                        <p className="text-gray-600 mt-1">Update the details of your room</p>
                    </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent ${errors.roomNo ? 'border-red-500' : 'border-gray-300'
                                            }`}
                                    />
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={handleInputChange}
                                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent ${errors.roomType ? 'border-red-500' : 'border-gray-300'
                                            }`}
                                    >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        step="0.01"
                                        min="0"
                                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent ${errors.price ? 'border-red-500' : 'border-gray-300'
                                            }`}
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        min="1"
                                        max="10"
                                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent ${errors.capacity ? 'border-red-500' : 'border-gray-300'
                                            }`}
                                    />
                                ...
                                <div className="bg-gray-50 rounded-lg p-4">
                                    ...
                                    <div className="space-y-2 text-sm">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${formData.status === 'Available' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                                }`}>
                                                {formData.status}
                                            </span>
                                        </div>
